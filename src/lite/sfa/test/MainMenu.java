...
public class MainMenu extends Activity {
	...
	public String[] btnNamesAgents = { "Utilizator", "Creare comanda", "Modificare comanda", "Afisare comanda", "Creare cmd GED", "Comenzi simulate",
			"Cmz.blocate limita credit", "Creare CLP", "Afisare CLP", "Modificare DL", "Modificare custodie", "Retur paleti", "Stare retur paleti",
			"Retur comenzi", "Obiective", "Vanzari", "Neincasate", "Stocuri", "Preturi", "Stare comenzi", "Realizare target", "Urmarire sablon", "Info client",
			"Plati CEC", "Clienti inactivi", "Clienti semiactivi", "Adrese clienti", "Info venituri", "Delegatii", "Despre", "Iesire" };

	public int[] btnImageAgents = new int[] { R.drawable.id_icon, R.drawable.new_icon, R.drawable.modif_icon, R.drawable.preview_icon,
			R.drawable.blue_basket_icon, R.drawable.simulate, R.drawable.cmd_bloc, R.drawable.clp, R.drawable.afis_clp, R.drawable.afis_clp,
			R.drawable.custody_48, R.drawable.modif_icon, R.drawable.status_retur_48, R.drawable.retur_comanda, R.drawable.colosseum, R.drawable.vanzari,
			...
			R.drawable.client_info, R.drawable.payment, R.drawable.vanzari, R.drawable.clienti_inactivi, R.drawable.location_icon, R.drawable.line_chart_icon,
	...
	public String[] btnNamesSD = { "Utilizator", "Creare comanda", "Modificare comanda", "Afisare comanda", "Creare cmd GED", "Cmz.blocate limita credit",
			"Creare CLP", "Aprobare CLP", "Afisare CLP", "Retur paleti", "Stare retur paleti", "Retur comenzi", "Modificare custodie", "Vanzari", "Neincasate",
			"Stocuri", "Obiective", "Preturi", "Preturi concurenta", "Stare comenzi", "Realizare target", "Articole avarie", "Creare sablon", "Afisare sablon",
			"Urmarire sablon", "Aprobare comanda", "Comenzi conditionate", "Info client", "Plati CEC", "Clienti inactivi", "Clienti semiactivi",
			"Adrese clienti", "Info venituri", "Delegatii", "Despre", "Iesire" };
	...
	public int[] btnImageSD = new int[] { R.drawable.id_icon, R.drawable.new_icon, R.drawable.modif_icon, R.drawable.preview_icon, R.drawable.blue_basket_icon,
			R.drawable.cmd_bloc, R.drawable.clp, R.drawable.aprob_clp, R.drawable.afis_clp, R.drawable.retur_marfa, R.drawable.status_retur_48,
			R.drawable.retur_comanda, R.drawable.custody_48, R.drawable.vanzari, R.drawable.neincasate, R.drawable.stoc_icon, R.drawable.dollar_icon,
			R.drawable.concurenta, R.drawable.znecesar1_icon, R.drawable.status, R.drawable.target, R.drawable.reduceri_icon, R.drawable.viewreduceri_icon,
	...
	public String[] btnNamesKA = { "Utilizator", "Creare comanda", "Modificare comanda", "Afisare comanda", "Cmz.blocate limita credit", "Creare CLP",
			"Afisare CLP", "Obiective", "Modificare custodie", "Retur paleti", "Stare retur paleti", "Retur comenzi", "Vanzari", "Neincasate", "Stocuri",
			"Preturi", "Stare comenzi", "Info client", "Plati CEC", "Clienti facturati", "Adrese clienti", "Delegatii", "Despre", "Iesire" };
	...
	public int[] btnImageKA = new int[] { R.drawable.id_icon, R.drawable.new_icon, R.drawable.modif_icon, R.drawable.preview_icon, R.drawable.cmd_bloc,
			R.drawable.clp, R.drawable.afis_clp, R.drawable.colosseum, R.drawable.custody_48, R.drawable.retur_marfa, R.drawable.status_retur_48,
			R.drawable.retur_comanda, R.drawable.vanzari, R.drawable.neincasate, R.drawable.stoc_icon, R.drawable.dollar_icon, R.drawable.status,
			R.drawable.client_info, R.drawable.payment, R.drawable.clienti_inactivi, R.drawable.location_icon, R.drawable.blank, R.drawable.despre_icon,
	...
	public String[] btnNamesCVA = { "Utilizator", "Creare cmd GED", "Modificare comanda", "Afisare comanda", "Comenzi simulate", "Creare CLP", "Afisare CLP",
			"Retur paleti", "Stare retur paleti", "Obiective", "Vanzari", "Neincasate", "Stocuri", "Preturi", "Stare comenzi", "Info client", "Delegatii",
			"Despre", "Iesire" };
	...
	public String[] btnNamesSM = { "Utilizator", "Creare comanda", "Creare cmd GED", "Modificare comanda", "Afisare comanda", "Comenzi simulate", "Creare CLP",
			"Aprobare CLP", "Afisare CLP", "Retur paleti", "Stare retur paleti", "Obiective", "Vanzari", "Neincasate", "Stocuri", "Preturi", "Stare comenzi",
	...
	public int[] btnImageSM = new int[] { R.drawable.id_icon, R.drawable.new_icon, R.drawable.blue_basket_icon, R.drawable.modif_icon, R.drawable.preview_icon,
			...
			R.drawable.colosseum, R.drawable.vanzari, R.drawable.neincasate, R.drawable.stoc_icon, R.drawable.dollar_icon, R.drawable.status,
	...
	public String[] btnNamesCONSGED = { "Utilizator", "Creare cmd GED", "Modificare comanda", "Afisare comanda", "Comenzi simulate", "Retur paleti",
			"Stare retur paleti", "Vanzari", "Neincasate", "Stocuri", "Preturi", "Stare comenzi", "Preturi concurenta", "Info client", "Despre", "Iesire" };
	...
	public int[] btnImageCONSGED = new int[] { R.drawable.id_icon, R.drawable.blue_basket_icon, R.drawable.modif_icon, R.drawable.preview_icon,
			R.drawable.simulate, R.drawable.retur_marfa, R.drawable.status_retur_48, R.drawable.vanzari, R.drawable.neincasate, R.drawable.stoc_icon,
			R.drawable.dollar_icon, R.drawable.status, R.drawable.concurenta, R.drawable.client_info, R.drawable.despre_icon, R.drawable.exit_icon };
	...
	public int[] btnImageINFO = new int[] { R.drawable.id_icon, R.drawable.new_icon, R.drawable.preview_icon, R.drawable.stoc_icon, R.drawable.dollar_icon,
			R.drawable.despre_icon, R.drawable.exit_icon };
	...
	public String[] btnNamesOIVPD = { "Utilizator", "Creare comanda", "Modificare comanda", "Afisare comanda", "Stocuri", "Preturi", "Despre", "Iesire" };

	public int[] btnImageOIVPD = new int[] { R.drawable.id_icon, R.drawable.new_icon, R.drawable.modif_icon, R.drawable.preview_icon, R.drawable.stoc_icon,
	...
	private Button modifCmdBtn, blocLimCredBtn, cmdCondBtn, aprobClp, aprobDl, aprobRetur, dlExpirat;
	...
	public class ButtonAdapter extends BaseAdapter {
		...
		class MyOnClickListener implements OnClickListener {
			...
			public void onClick(View v) {
				...
				// afisare dl
				if (selectedBtnName.equalsIgnoreCase("Modificare DL")) {
	...
	public void startModifCmdBtnAnimation(String result) {
		...
		// cele blocate pt. limita de credit
		{
			...
			// Afisare DL-uri expirate
			dlExpirat = (Button) gridview.findViewById(getBtnPosByName("Modificare DL"));

			if (dlExpirat != null) {
				if (tipRes[2].equals("1")) {
					this.dlExpirat.startAnimation(animation);
				} else {
					this.dlExpirat.clearAnimation();
				}
			}
	...
	private int getNrBtns() {
		...
		if ((UserInfo.getInstance().getTipUser().equals("CV") || UserInfo.getInstance().getTipUser().equals("SM") || UserInfo.getInstance().getTipUser()
				.equals("SC"))
				&& (!UserInfo.getInstance().getTipUserSap().equals("CONS-GED") && !UserInfo.getInstance().getTipUserSap().equals("SMR") && !UserInfo
						.getInstance().getTipUserSap().equals("CVR"))) {
