package lite.sfa.test.voce.adapters;
...
public class ClientAdapter extends BaseAdapter {
	...
	static class ViewHolder {
		TextView textNumeClient, textTipClient, textNrCrt;
	}

	public ClientAdapter(Context context, List<BeanClient> listClienti) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.client_item_voce, parent, false);
		...
		viewHolder.textNrCrt.setText("" + (position + 1));
