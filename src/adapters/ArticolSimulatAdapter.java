...
public class ArticolSimulatAdapter extends BaseAdapter {
	...
	public static class ViewHolder {
		TextView textNrCrt, textNumeArt, textCodArt, textCantArt, textUmArt, textPretArt, textMonedaArt, textDepozit, textProcRed, textStatusStoc;
	}
