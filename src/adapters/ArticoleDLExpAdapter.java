...
public class ArticoleDLExpAdapter extends BaseAdapter {

	Context context;
	List<ArticolCLP> listArticole;
	int[] colors = new int[] { 0x3098BED9, 0x30E8E8E8 };

	public ArticoleDLExpAdapter(Context context, List<ArticolCLP> listArticole) {
		this.context = context;
		this.listArticole = listArticole;
	}

	static class ViewHolder {
		TextView textNrCrt, textNumeArt, textCodArt, textCantArt, textUmArt, textDepozit;
	}
