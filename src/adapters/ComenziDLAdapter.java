...
public class ComenziDLAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.textStatusClp.setText(documentDL.getStatusDocument() + System.getProperty("line.separator")
				+ InfoStrings.statusAprobCmd(Integer.valueOf(documentDL.getFurnizor())));
