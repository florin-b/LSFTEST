...
public enum EnumDepartExtra {
	...
	DISTRIBUTIE("Distributie", "00"), LEMNOASE("Lemnoase", "01"), FERONERIE("Feronerie", "02"), PARCHET("Parchet", "03"), MATERIALE_GRELE(
			"Materiale grele", "04"), ELECTRICE("Electrice", "05"), GIPS("Gips", "06"), CHIMICE("Chimice", "07"), INSTALATII(
