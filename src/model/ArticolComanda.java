...
public class ArticolComanda implements Comparable<ArticolComanda> {
    ...
    public String toString() {
        return "ArticolComanda [numeArticol=" + numeArticol + ", codArticol="
                + codArticol + ", ponderare=" + ponderare + "]";
    }
    ...
    public static Comparator<ArticolComanda> DepartComparator = new Comparator<ArticolComanda>() {
        ...
        public int compare(ArticolComanda depart1, ArticolComanda depart2) {
            ...
            if (depart1 != null)
                departName1 = depart1.getDepart().toUpperCase(
                        Locale.getDefault());

            if (depart2 != null)
                departName2 = depart2.getDepart().toUpperCase(
                        Locale.getDefault());
